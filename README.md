My pure Python 3.x implementation of [The Ray Tracer Challenge](http://raytracerchallenge.com/). Requires NumPy for matrix operations; otherwise, has no dependencies.
